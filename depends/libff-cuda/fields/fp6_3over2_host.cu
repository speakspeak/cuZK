#ifndef __FP6_3OVER2_HOST_CU__
#define __FP6_3OVER2_HOST_CU__
...
bool Fp6_3over2_model_host<n>::operator==(const Fp6_3over2_model_host<n>& other) const
{
...
template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::operator+(const Fp6_3over2_model_host<n>& other) const
{
    return Fp6_3over2_model_host<n>(params, this->c0 + other.c0, 
                                       this->c1 + other.c1, 
                                       this->c2 + other.c2);
}
...
{
    return Fp6_3over2_model_host<n>(rhs.params, lhs * rhs.c0, 
                                           lhs * rhs.c1,
                                           lhs * rhs.c2);
}
...
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::operator*(const Fp6_3over2_model_host<n>& other) const
{
    ...
    return Fp6_3over2_model_host<n>(params, aA + this->mul_by_non_residue((b + c) * (B + C) - bB - cC),
                                       (a + b) * (A + B) - aA - bB + this->mul_by_non_residue(cC),
                                       (a + c) * (A + C) - aA + bB - cC);
}

template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::operator-() const
{
    return Fp6_3over2_model_host<n>(params, -this->c0, -this->c1, -this->c2);
}
...
template<mp_size_t n> 
Fp2_model_host<n> Fp6_3over2_model_host<n>::mul_by_non_residue(const Fp2_model_host<n>& elt) const 
{
    Fp2_model_host<n> non_residue(params->fp2_params, *params->non_residue_c0, *params->non_residue_c1);
    return Fp2_model_host<n>(non_residue * elt);
}

template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::dbl() const
{
    return Fp6_3over2_model_host<n>(params, this->c0.dbl(), 
                                       this->c1.dbl(), 
                                       this->c2.dbl());
}

template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::squared() const
{
    ...
    return Fp6_3over2_model_host<n>(params, s0 + this->mul_by_non_residue(s3),
                                       s1 + this->mul_by_non_residue(s4),
                                       s1 + s2 + s3 - s0 - s4);
}

template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::inverse() const
{
    ...
    return Fp6_3over2_model_host<n>(params, t6 * c0, t6 * c1, t6 * c2);
}

template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::Frobenius_map(unsigned long power) const
{
    ...
    return Fp6_3over2_model_host<n>(params, c0.Frobenius_map(power),
...
template<mp_size_t n> 
void Fp6_3over2_model_host<n>::set_params(Fp6_3over2_params_host<n>* params)
{
    this->params = params;
...
template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::zero()
{
    Fp2_model_host<n> t(params->fp2_params);
    return Fp6_3over2_model_host<n>(params, t.zero(), t.zero(), t.zero());
}

template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::one()
{
    Fp2_model_host<n> t(params->fp2_params);
    return Fp6_3over2_model_host<n>(params, t.one(), t.zero(), t.zero());
}


template<mp_size_t n> 
Fp6_3over2_model_host<n> Fp6_3over2_model_host<n>::random_element()
{
    Fp2_model_host<n> t(params->fp2_params);
    Fp6_3over2_model_host<n> r(params);
