#ifndef __BLS12_381_PAIRING_CU__
#define __BLS12_381_PAIRING_CU__

namespace libff {

__device__ bls12_381_ate_G1_precomp::bls12_381_ate_G1_precomp() : PX(&bls12_381_fp_params_q), PY(&bls12_381_fp_params_q) 
{

}

__device__ bool bls12_381_ate_G1_precomp::operator==(const bls12_381_ate_G1_precomp &other) const
{
    return (this->PX == other.PX && this->PY == other.PY);
}

__device__ bls12_381_ate_ell_coeffs::bls12_381_ate_ell_coeffs() : ell_0(&bls12_381_fp2_params_q), ell_VW(&bls12_381_fp2_params_q), ell_VV(&bls12_381_fp2_params_q)
{ 

}

__device__ bool bls12_381_ate_ell_coeffs::operator==(const bls12_381_ate_ell_coeffs &other) const
{
    return (this->ell_0 == other.ell_0 && this->ell_VW == other.ell_VW && this->ell_VV == other.ell_VV);
}

__device__ bls12_381_ate_G2_precomp::bls12_381_ate_G2_precomp() : QX(&bls12_381_fp2_params_q), QY(&bls12_381_fp2_params_q), coeffs_size(0) 
{

}

__device__ bls12_381_ate_G2_precomp::~bls12_381_ate_G2_precomp()
{
    if (coeffs_size > 0)
    {
        coeffs_size = 0;
...
__device__ bool bls12_381_ate_G2_precomp::operator==(const bls12_381_ate_G2_precomp &other) const
{
...
__device__ bls12_381_Fq12 bls12_381_final_exponentiation_first_chunk(const bls12_381_Fq12 &elt)
{
    ...
    */
    ...
    const bls12_381_Fq12 A = bls12_381_Fq12(&bls12_381_fp12_params_q, elt.c0,-elt.c1);
...
__device__ bls12_381_Fq12 bls12_381_exp_by_z(const bls12_381_Fq12 &elt)
{
...
__device__ bls12_381_Fq12 bls12_381_final_exponentiation_last_chunk(const bls12_381_Fq12 &elt)
{
...
__device__ void doubling_step_for_miller_loop(const bls12_381_Fq two_inv, bls12_381_G2 &current, bls12_381_ate_ell_coeffs &c)
{
...
__device__ void mixed_addition_step_for_miller_loop(const bls12_381_G2 base, bls12_381_G2 &current, bls12_381_ate_ell_coeffs &c)
{
...
__device__ bls12_381_ate_G2_precomp bls12_381_ate_precompute_G2(const bls12_381_G2& Q)
{
    ...
    bls12_381_Fq two_inv = (bls12_381_Fq(&bls12_381_fp_params_q, "2").inverse()); // could add to global params if needed

    bls12_381_ate_G2_precomp result;
    result.QX = Qcopy.X;
    result.QY = Qcopy.Y;

    bls12_381_G2 R(&g2_params);
    R.X = Qcopy.X;
    R.Y = Qcopy.Y;

    bls12_381_Fq2 t(&bls12_381_fp2_params_q);
    R.Z = t.one();

    const bigint<bls12_381_q_limbs>& loop_count = *bls12_381_ate_loop_count;
    ...
    result.coeffs = new bls12_381_ate_ell_coeffs[result.coeffs_size];
    size_t idx = 0;
    found_one = false;
...
__device__ bls12_381_Fq12 bls12_381_ate_miller_loop(const bls12_381_ate_G1_precomp &prec_P, const bls12_381_ate_G2_precomp &prec_Q)
{
    ...
    bls12_381_Fq12 t(&bls12_381_fp12_params_q);
    bls12_381_Fq12 f = t.one();
...
__device__ bls12_381_Fq12 bls12_381_miller_loop(const bls12_381_G1_precomp &prec_P,
